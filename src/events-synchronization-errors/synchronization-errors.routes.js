...
(function() {
    ...
    function routes($stateProvider) {
        $stateProvider.state('openlmis.eventsSynchronizationErrors', {
            url: '/synchronizationErrors?page&size',
            views: {
                '@openlmis': {
                    controller: 'SynchronizationErrorsController',
                    templateUrl: 'events-synchronization-errors/synchronization-errors.html',
                    controllerAs: 'vm'
                }
            },
            resolve: {
